...
#include "FlashAPI/F021_F28004x_C28x.h"
...
flash_new(const struct net *drv)
{
    static const struct flash_sector map[] = {
        FLASH_SECTOR_INIT(0x80000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x81000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x82000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x83000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x84000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x85000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x86000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x87000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x88000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x89000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x8A000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x8B000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x8C000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x8D000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x8E000UL, 0x1000U),
        FLASH_SECTOR_INIT(0x8F000UL, 0x1000U)
    };
...
flash__open(const struct net *net, const struct flash_usr *usr)
{
    ...
    st = Fapi_initializeAPI(F021_CPU0_BASE_ADDRESS, _clk->cpu.MHz);
