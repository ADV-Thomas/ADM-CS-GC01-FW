 ...
 * \file hw_spi.h
 * 
 * \brief Definitions for SPI registers
 * 
 * \author Jorge Sola
 * 
 *************************************************************************************************/
...
#define SPI_S_CCR     1   // SPI Configuration Control Register
#define SPI_S_CTL     1   // SPI Operation Control Register
#define SPI_S_STS     1   // SPI Status Register
#define SPI_S_BRR     1   // SPI Baud Rate Register
#define SPI_S_RXEMU   1   // SPI Emulation Buffer Register
#define SPI_S_RXBUF   1   // SPI Serial Input Buffer Register
#define SPI_S_TXBUF   1   // SPI Serial Output Buffer Register
#define SPI_S_DAT     1   // SPI Serial Data Register
#define SPI_S_FFTX    1   // SPI FIFO Transmit Register
#define SPI_S_FFRX    1   // SPI FIFO Receive Register
#define SPI_S_FFCT    1   // SPI FIFO Control Register
#define SPI_S_PRI     1   // SPI Priority Control Register
